...
public class CompanyCriterySearch {
    ...
    public CompanyCriterySearch() {
        super();
    }

    public CompanyCriterySearch(List<Long> nn, String byName) {
        this();
        this.nn = nn;
        this.byName = byName;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompanyCriterySearch that)) return false;
